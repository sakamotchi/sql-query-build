...
**これらは永続化ドキュメントではなく、開発作業中の一時的なドキュメントです。**
...
| `testing.md` | テスト手順書。可能な限り操作手順で確認する方法を記載。操作で確認できない項目のみテストコードを記載 |

#### ディレクトリ命名例

```
docs/working/20251229_query-execution/
docs/working/20251230_export-csv/
docs/working/20250105_keychain-frontend/
```

#### 開発作業完了後の扱い

- 開発作業が完了したら、永続化ドキュメントを更新する
- 開発作業ドキュメントは `docs/archive/` に移動するか、削除する
- 重要な設計判断や経緯は永続化ドキュメントに反映させる
