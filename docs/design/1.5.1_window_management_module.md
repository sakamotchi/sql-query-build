...
impl WindowManager {
    ...
    pub fn create_window(
        ...
        let url = match options.window_type {
            ...
            WindowType::QueryBuilder => {
                let path = match &options.connection_id {
                    Some(id) => format!("index.html#/query-builder?connectionId={}", id),
                    None => "index.html#/query-builder".to_string(),
                };
                WebviewUrl::App(path.into())
            }
            WindowType::Settings => WebviewUrl::App("index.html#/settings".into()),
        };
        ...
        // ウィンドウ状態を記録
        let window_state = WindowState::new(options.window_type.clone(), options.connection_id.clone());
        self.windows
            .lock()
            .unwrap()
