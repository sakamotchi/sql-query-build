...
| タスクID | タスク名 | 状態 | 依存 |
|---------|---------|------|------|
| 2.3.1.1 | QueryErrorCode列挙型の拡充（Rust） | ✅ 完了 | - |
| 2.3.1.2 | QueryErrorDetails構造体の拡充（Rust） | ✅ 完了 | - |
| 2.3.1.3 | PostgreSQLエラーマッピング実装 | ✅ 完了 | 2.3.1.1 |
| 2.3.1.4 | MySQLエラーマッピング実装 | ✅ 完了 | 2.3.1.1 |
| 2.3.1.5 | SQLiteエラーマッピング実装 | ✅ 完了 | 2.3.1.1 |
| 2.3.1.6 | フロントエンドQueryErrorCode型更新 | ✅ 完了 | 2.3.1.1 |
| 2.3.1.7 | フロントエンドQueryErrorDetails型更新 | ✅ 完了 | 2.3.1.2 |
