...
describe('FromMasterPasswordDialog', () => {
  let FromMasterPasswordDialog: typeof import('./FromMasterPasswordDialog.vue').default

  beforeAll(async () => {
    FromMasterPasswordDialog = (await import('./FromMasterPasswordDialog.vue')).default
  })
