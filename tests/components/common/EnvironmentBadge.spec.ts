...
describe('EnvironmentBadge', () => {
  let EnvironmentBadge: typeof import('~/components/common/EnvironmentBadge.vue').default

  beforeAll(async () => {
    EnvironmentBadge = (await import('~/components/common/EnvironmentBadge.vue')).default
  })
