...
describe('MasterPasswordSetupDialog', () => {
  let MasterPasswordSetupDialog: typeof import('~/components/security/MasterPasswordSetupDialog.vue').default

  beforeAll(async () => {
    MasterPasswordSetupDialog = (await import('~/components/security/MasterPasswordSetupDialog.vue')).default
  })
