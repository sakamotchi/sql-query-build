...
impl From<ConnectionInfo> for FrontendConnection {
    fn from(conn: ConnectionInfo) -> Self {
        ...
        Self {
            ...
            name: conn.name,
            environment,
            theme_color: conn.environment.theme_color,
            theme_background_color: conn.environment.theme_background_color,
            host,
            port,
            database,
            username,
    ...
    fn try_from(frontend: FrontendConnection) -> Result<Self, Self::Error> {
        ...
        Ok(ConnectionInfo {
            ...
            environment: super::EnvironmentConfig {
                environment_type,
                theme_color: frontend.theme_color,
                theme_background_color: frontend.theme_background_color,
